...
dict(id='S34', nom='Le studio (mini-DAW)', fam=3, h='#### 7. Depuis 1990 — streaming, normalisation et synthèse', prio=2, effort='XL', audio='🎙🔊',
 ...
 montre='Tout le dossier réuni dans l’outil qui a remplacé le studio de Schaeffer : instruments de synthèse, séquenceur, effets, console. Au bout de la chaîne, le LUFS-mètre rend visible la guerre du volume.',
