...
dict(id='S04', nom='La corde de d’Alembert', fam=1, h='#### Corde de Mersenne', prio=3, effort='L', audio='🔊',
 ...
 usage='Pincer la corde à la souris, écouter, lire la fréquence mesurée. Doubler la tension, puis la longueur ; pincer au milieu, puis près du chevalet.',
...
dict(id='S34', nom='Le studio (mini-DAW)', fam=3, h='#### 7. Depuis 1990 — streaming, normalisation et synthèse', prio=2, effort='XL', audio='🎙🔊',
 ...
 usage='Enregistrer une voix, ajouter une piste de générateur, poser un délai de 10 ms d’un côté (Haas), une réverbération de S24, puis exporter en WAV. Tout reste dans le navigateur.',
 montre='Tout le dossier assemblé dans l’outil qui a remplacé le studio de Schaeffer ; le LUFS-mètre qui rend visible la loudness war.',
 lecture='Regarder le master : le crête-mètre et le LUFS-mètre ne disent pas la même chose. Écraser une piste au compresseur fait monter le LUFS, pas la musique.'),
...
dict(id='S41', nom='Source-filtre : la voix', fam=4, h='#### Voix — deux étages, pas un tuyau magique', prio=3, effort='L', audio='🔊',
 ...
 usage='Choisir une voyelle, faire varier f₀ sans toucher au conduit ; puis garder f₀ et changer de voyelle ; activer le formant du chanteur sur un accompagnement d’orchestre.',
...
dict(id='S42', nom='Vos propres voyelles', fam=4, h='#### Voix — deux étages, pas un tuyau magique', prio=3, effort='L', audio='🎙',
 ...
 usage='Tenir un [a] dans le micro, regarder le point apparaître sur la carte des voyelles, puis passer à [i] et [u].',
