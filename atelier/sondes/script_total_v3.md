...
**Dossier VI (proposé) · Exploration spatiale — Empire contre Intox** — *un dossier **Provoxys & Lalie***
...
>
> **Script total v3 — mise à jour Provoxys & Lalie (juin 2026).** Réécriture **détaillée,
> style Provoxys**, enrichie de la mise à jour des auteurs : **nouveaux engins** (MAVEN, Solar
> Orbiter, OSIRIS-APEX, Luna 1 & 2, Gaia, Cheops, Subaru, Gemini, LBT, Vera C. Rubin/LSST, CTA),
> les **responsables derrière chaque mission** (👥 PI / scientifiques), et le chapitre
> **« Les Femmes de l'Espace »** de **Lalie**. Fiches techniques ultra-granulaires (constructeur,
> parties pièce par pièce, matériaux, chaque instrument développé, défis, données). Toujours
> **zéro doublon** ; écarts chiffrés réconciliés (⚠️). v1 (court) et v2 conservés comme historique.
>
...
> Données* · 📍 **Où aujourd'hui ?** = localisation/orbite/distance, mi-2026) · 👥 **Derrière** = responsables (PI / scientifiques) · `> **Explication —**` = encadré grand public · **Repère ·** = mini-explicateur
...
👥 *Derrière — James Van Allen (université de l'Iowa), dont le détecteur a révélé les ceintures de radiation qui portent son nom.*
...
👥 *Derrière — John Robinson Pierce (Bell Labs), théoricien des satellites de communication.*
...
👥 *Derrière — **Nancy Grace Roman**, « mère de Hubble » et première femme cadre de la NASA, qui en a défini la stratégie (→ chapitre « Les Femmes de l'Espace ») ; project scientists Robert Williams puis Jennifer Wiseman.*
...
### Cartographier et caractériser — Gaia & Cheops (ESA)

Tous les satellites ne servent pas la Terre : certains scrutent le ciel. Deux missions européennes ont transformé l'astronomie depuis l'orbite.

📋 **Fiche — Gaia**
📍 *Où aujourd'hui ? — A opéré au point de Lagrange L2 (~1,5 M km) de 2013 à 2025 ; observations scientifiques achevées, catalogue final en préparation.*
- **Identité —** ESA ; constructeur Airbus Defence and Space. Lancement : 19 déc. 2013. **Masse :** 2 030 kg ; optiques en Zerodur.
- **Mission —** astrométrie de précision : mesurer position, distance et mouvement de **plus d'un milliard d'étoiles** pour dresser la **carte 3D la plus précise de la Voie lactée**.
- **Résultats —** a révélé des courants stellaires et l'histoire des collisions de notre Galaxie ; a débusqué en prime astéroïdes et exoplanètes.
👥 *Derrière — project scientist Timo Prusti (ESA).*

📋 **Fiche — Cheops**
📍 *Où aujourd'hui ? — Active, en orbite héliosynchrone à ~700 km d'altitude.*
- **Identité —** ESA + Suisse ; constructeur Airbus Defence and Space. Lancement : 18 déc. 2019. **Masse :** 273 kg ; télescope de **32 cm**.
- **Mission —** photométrie ultra-précise des **transits d'exoplanètes déjà connues**, pour mesurer leur taille et leur densité.
👥 *Derrière — principal investigator Willy Benz.*
...
#### Luna 1 — la première évasion (URSS, 2 janvier 1959)

📋 **Fiche — Luna 1**
📍 *Fin de vie — Devenue le premier objet en orbite héliocentrique : elle tourne toujours autour du Soleil, entre la Terre et Mars, sous le surnom de « Mechta » (le Rêve).*
- **Identité —** OKB-1 (Korolev). Lancement : 2 janvier 1959 (R-7). **Masse :** 361 kg ; structure aluminium.
- **Histoire —** **premier objet à s'arracher à l'attraction terrestre.** Devait percuter la Lune ; une erreur de synchronisation la fait passer à ~5 995 km — elle entre alors en **orbite autour du Soleil**, une première historique.
- **Instruments & données —** magnétomètre, compteur Geiger, détecteurs de particules : Luna 1 **n'a détecté aucun champ magnétique lunaire significatif** et a mesuré directement le **vent solaire** dans l'espace interplanétaire.
👥 *Derrière — le bureau OKB-1 de Sergueï Korolev.*

#### Luna 2 — le premier contact (URSS, 12 septembre 1959)

📋 **Fiche — Luna 2**
📍 *Fin de vie — Écrasée sur la Lune le 14 septembre 1959 — premier objet humain à toucher un autre monde.*
- **Identité —** OKB-1 (Korolev). Lancement : 12 sept. 1959. **Masse :** 390 kg ; structure aluminium.
- **Histoire —** **premier impact d'un engin humain sur un autre corps céleste** (14 sept. 1959). Emportait des fanions soviétiques en sphères, dispersés au choc — la première « empreinte » humaine sur un autre monde.
- **Données —** comme Luna 1, magnétomètre et détecteurs de particules : a **confirmé l'absence de champ magnétique lunaire** et suivi le vent solaire jusqu'à l'impact.
...
👥 *Derrière — équipe Pioneer de NASA Ames (Charles Hall) ; la plaque gravée conçue par Carl Sagan et Frank Drake.*
...
👥 *Derrière — project scientist **Edward C. Stone**, à la barre pendant plus de 40 ans ; le Golden Record imaginé par Carl Sagan, Ann Druyan, Timothy Ferris et Frank Drake.*
...
### MAVEN — pourquoi Mars a perdu son ciel (NASA, 18 novembre 2013)

*Visuel — l'orbiteur et ses panneaux solaires au-dessus de l'atmosphère ténue de Mars (modèle 3D non encore dans l'aperçu).*

Mars fut tiède et humide ; elle est aujourd'hui un désert glacé. **MAVEN** enquête sur ce meurtre climatique — non pas au sol, mais en haute atmosphère, là où le **vent solaire** arrache, molécule par molécule, l'air d'une planète privée de bouclier magnétique.

📋 **Fiche — MAVEN (Mars Atmosphere and Volatile EvolutioN)**
📍 *Où aujourd'hui ? — Active, en orbite elliptique autour de Mars depuis le 22 septembre 2014.*
- **Identité —** NASA ; constructeur Lockheed Martin. Lancement : 18 nov. 2013. **Masse au lancement :** 2 454 kg ; panneaux solaires.
- **Instruments —** 8 instruments (spectromètres, magnétomètre, analyseurs de particules et d'ions) mesurant l'échappement atmosphérique.
- **Résultats —** a **quantifié la fuite de l'atmosphère** sous l'effet du vent solaire, expliquant comment Mars est passée d'un monde potentiellement habitable à un désert froid ; a détecté des **aurores** martiennes diffuses.
👥 *Derrière — project scientist Shannon Curry.*
...
👥 *Derrière — project scientist **Linda Spilker** (NASA/JPL) ; équipe d'imagerie Carolyn Porco ; Huygens : Jean-Pierre Lebreton (ESA). (Linda Spilker → chapitre « Les Femmes de l'Espace ».)*
...
👥 *Derrière — PI Alan Stern (Southwest Research Institute).*
...
👥 *Derrière — project scientist ESA Richard Harrison ; LASCO : Guenter Brueckner (NRL) ; EIT : Jean-Pierre Delaboudinière ; MDI : Philip Scherrer (Stanford).*
...
👥 *Derrière — project scientist Nour Raouafi (JHUAPL) ; la sonde porte le nom d'Eugene Parker, qui théorisa le vent solaire en 1958.*
...
### Solar Orbiter — le premier regard sur les pôles du Soleil (ESA/NASA, 10 février 2020)

*Modèle 3D Sketchfab disponible (« Solar Orbiter ») — le bouclier thermique percé de hublots et les panneaux solaires inclinés.*

📋 **Fiche — Solar Orbiter**
📍 *Où aujourd'hui ? — Active, sur une orbite héliocentrique de plus en plus inclinée, s'approchant jusqu'à ~0,28 UA du Soleil (~42 millions de km).*
- **Identité —** ESA avec contribution NASA ; constructeur Airbus Defence and Space. Lancement : 10 fév. 2020. **Masse au lancement :** ~1 800 kg.
- **Instruments —** 10 instruments, dont *EUI* (imagerie ultraviolette) et *Metis* (coronographe), complétés d'analyseurs in-situ du vent solaire et du champ magnétique.
- **Résultats —** a livré en 2025 les **premières images des pôles du Soleil** ; complète Parker (qui plonge dans la couronne) par une vue d'ensemble inclinée.
👥 *Derrière — project scientist Daniel Müller (ESA).*
...
👥 *Derrière — project scientist Ken Farley, project manager Jennifer Trosper ; descente martienne (GNC) pilotée par **Swati Mohan** ; Ingenuity : chief engineer Bob Balaram. (Swati Mohan → chapitre « Les Femmes de l'Espace ».)*
...
📋 **Keck I & II (Mauna Kea, 1993/96)** — deux miroirs de **10 m** faits chacun de **36 segments hexagonaux** alignés au nanomètre, équipés d'**optique active et adaptative**. C'est la révolution du miroir segmenté, qui rend possibles les géants à venir. 👥 *Derrière — concept des miroirs segmentés inventé par Jerry Nelson.*

📋 **VLT (ESO, Cerro Paranal, Chili)** — quatre télescopes de **8,2 m** (Antu, Kueyen, Melipal, Yepun) + quatre auxiliaires mobiles de 1,8 m, combinables en interféromètre (**VLTI**, bases jusqu'à ~200 m, résolution milliarcseconde). L'observatoire au sol le plus productif au monde — première image directe d'une exoplanète, suivi des étoiles autour du trou noir central de notre Galaxie. 👥 *Derrière — optique adaptative ESO : Norbert Hubin.*
...
📋 **Subaru (Mauna Kea, 1999)** — **8,2 m monolithique** (Zerodur), NAOJ (Japon). Réputé pour la qualité de ses images grand champ ; sa caméra *Hyper Suprime-Cam* sonde matière noire et énergie noire.

📋 **Gemini (Mauna Kea + Cerro Pachón, 1999-2001)** — **deux télescopes de 8,1 m**, un par hémisphère (consortium AURA, international), pour couvrir **tout le ciel** ; l'instrument *GPI* est dédié à l'imagerie directe d'exoplanètes.

📋 **LBT — Large Binocular Telescope (Mont Graham, Arizona, 2004)** — **deux miroirs de 8,4 m** sur une monture commune (ouverture équivalente ~11,9 m), une vision « binoculaire » de l'Univers ; consortium USA/Allemagne/Italie. Disques protoplanétaires, exoplanètes.

📋 **Vera C. Rubin Observatory / LSST (Cerro Pachón, Chili, ~2025-2026)** — **8,4 m** doté de la **plus grande caméra du monde (3,2 milliards de pixels)** ; il relève **tout le ciel toutes les quelques nuits pendant 10 ans** (Legacy Survey of Space and Time) — millions de supernovae, astéroïdes, cartographie de la matière noire. Nommé d'après **Vera Rubin**, qui établit les premières preuves de la matière noire (→ chapitre « Les Femmes de l'Espace »).

📋 **CTA — Cherenkov Telescope Array (Europe + Chili, en construction)** — non pas un, mais **des dizaines de télescopes** captant les éclairs Tcherenkov des **rayons gamma** de très haute énergie (trous noirs, supernovae, matière noire) : le plus grand observatoire gamma au sol.
...
👥 *Derrière — FAST : Nan Rendong, « père de FAST », mort en 2017 avant son achèvement ; Arecibo : conçu par William Gordon, et le message d'Arecibo (1974) par Frank Drake et Carl Sagan ; SKA : directeur général Philip Diamond.*
...
📋 **OSIRIS-APEX (NASA, → Apophis 2029).** Réincarnation d'**OSIRIS-REx** (qui a rapporté en 2023 un échantillon de l'astéroïde Bennu) : la sonde, rebaptisée, file vers **(99942) Apophis**, qu'elle étudiera après son **passage rapproché de la Terre le 13 avril 2029** — un astéroïde de ~340 m qui frôlera notre planète plus près que les satellites géostationnaires. Objectif : observer comment la gravité terrestre **remanie sa surface**. 👥 *Derrière — équipe dirigée par Dante Lauretta.*
...
## Intermède · Les Femmes de l'Espace — le cerveau et l'architecte

*Chapitre de **Lalie**. « Si les sondes et les télescopes sont nos *yeux* dans l'espace, ces femmes en ont été le *cerveau* et l'architecte. »*

L'exploration spatiale se raconte d'ordinaire à travers ses machines. Mais derrière chaque trajectoire, chaque ligne de code, chaque donnée transformée en découverte, il y a des femmes — longtemps restées dans l'ombre. Mathématiciennes, ingénieures, informaticiennes, planétologues : voici quelques-unes de celles sans qui rien de ce dossier n'existerait.

### Les calculatrices humaines et l'aube du logiciel

- **Katherine Johnson** (NASA) — spécialiste de la mécanique orbitale ; ses calculs de trajectoires, d'une précision absolue, furent vitaux pour les premières missions.
- **Dorothy Vaughan** (NACA/NASA) — mathématicienne devenue programmeuse ; elle apprend le **Fortran** en autodidacte pour automatiser le calcul des trajectoires et anticipe la révolution informatique.
- **Mary Jackson** (NACA/NASA) — ingénieure aérospatiale ; ses études en soufflerie garantissaient que les structures résisteraient aux conditions extrêmes du lancement et de la rentrée.
- **Margaret Hamilton** (MIT, Apollo) — directrice du génie logiciel ; elle introduit des concepts de **fiabilité logicielle** qui sauvent l'alunissage d'Apollo 11. On lui doit, en grande partie, l'expression « génie logiciel ».

### Stratèges, pilotes, directrices de mission

- **Nancy Grace Roman** (NASA) — « **mère de Hubble** », première femme cadre de la NASA ; sans son plaidoyer, le télescope spatial n'aurait pas vu le jour. Le futur observatoire **Nancy Grace Roman** (chapitre V) porte son nom.
- **Linda Spilker** (NASA/JPL) — planétologue, responsable scientifique de **Cassini** ; elle a piloté les objectifs et l'arbitrage des instruments durant treize ans autour de Saturne.
- **Swati Mohan** (NASA/JPL) — responsable du guidage et contrôle (GNC) de **Perseverance** ; c'est elle qui annonça « *touchdown confirmed* » lors de la descente de 2021.
- **Ritu Karidhal** & **Muthayya Vanitha** (ISRO, Inde) — la « Rocket Woman » de Mangalyaan (autonomie logicielle de la sonde martienne) et la première femme à diriger un projet interplanétaire indien (Chandrayaan-2).
- **Sarah Al-Amiri** (Émirats) — cheffe de projet de la sonde **Hope** (Emirates Mars Mission), pilier scientifique d'une première historique pour son agence.

### Analyser, découvrir

- **Jocelyn Bell Burnell** (Royaume-Uni) — découvre les **pulsars** en 1967 en scrutant des signaux radio, ouvrant un pan entier de l'astrophysique.
- **Katie Bouman** (États-Unis) — conçoit l'algorithme qui assemble les pétaoctets de l'Event Horizon Telescope pour produire la **première image d'un trou noir** (2019).
- **Vera Rubin** (États-Unis) — ses mesures de rotation des galaxies fournissent les premières preuves solides de la **matière noire** ; l'observatoire LSST (chapitre IV) porte son nom.

> **Repère · « chirurgiennes de l'espace ».** Quand une sonde tombe en panne à des millions
> de km, les équipes au sol sont son seul recours : diagnostiquer par la seule télémétrie,
> réécrire le logiciel embarqué, l'envoyer à travers l'espace. C'est ce travail invisible,
> souvent porté par des ingénieures, qui maintient les missions en vie sur des décennies.

| Nom | Institution | Rôle | Contribution clé |
|---|---|---|---|
| Katherine Johnson | NASA | Mathématicienne | Trajectoires orbitales et lunaires |
| Dorothy Vaughan | NACA/NASA | Mathématicienne / info | Programmation Fortran, calcul automatisé |
| Mary Jackson | NACA/NASA | Ingénieure aérospatiale | Souffleries, résistance des structures |
| Margaret Hamilton | MIT / Apollo | Ingénieure logicielle | Logiciel de vol, fiabilité d'Apollo |
| Nancy Grace Roman | NASA | Astrophysicienne | Stratégie du télescope Hubble |
| Linda Spilker | NASA/JPL | Planétologue | Responsable scientifique de Cassini |
| Swati Mohan | NASA/JPL | Ingénieure GNC | Descente de Perseverance (2021) |
| Ritu Karidhal | ISRO | Dir. opérations | Autonomie logicielle de Mangalyaan |
| Muthayya Vanitha | ISRO | Directrice de projet | Intégration de Chandrayaan-2 |
| Sarah Al-Amiri | EAU / EMM | Cheffe de projet | Stratégie de la sonde Hope |
| Jocelyn Bell Burnell | Royaume-Uni | Astrophysicienne | Découverte des pulsars |
| Katie Bouman | États-Unis | Informaticienne | 1ʳᵉ image d'un trou noir |
| Vera Rubin | États-Unis | Astronome | Preuves de la matière noire |

*Profils complémentaires (santé, chimie, instrumentation en microgravité) : Valentina Tereshkova (URSS), Chiaki Mukai (JAXA), Fabiola Gianotti (CERN), Helen Sharman (R.-U.), Eileen Collins (NASA) — détaillés dans la source `sources/nouveau/femme-espace.txt`.*

*Réalisé par Lalie. Sources : NASA & National Women's History Museum, ESA, ISRO, JPL, Event Horizon Telescope, Chandra X-ray Observatory.*
...
*Réalisé par **Provoxys** (script & technique) & **Lalie** (« Les Femmes de l'Espace »).*
...
| Gaia | ⚪ | a opéré à **L2** (2013-2025) | observations achevées |
| Cheops | 🟢 | orbite héliosynchrone | ~700 km |
...
| Luna 1 | ⚪ | orbite héliocentrique (« Mechta ») | autour du Soleil, Terre-Mars |
| Luna 2 | ⚪ | écrasée sur la Lune (14 sept. 1959) | surface lunaire |
...
| MAVEN | 🟢 | orbite de Mars (depuis 2014) | elliptique martienne |
...
| Solar Orbiter | 🟢 | orbite héliocentrique inclinée | jusqu'à ~0,28 UA du Soleil |
...
| Subaru | 🟢 | Mauna Kea (Hawaï) | au sol |
| Gemini N/S | 🟢 | Mauna Kea + Cerro Pachón | au sol |
| LBT | 🟢 | Mont Graham (Arizona) | au sol |
...
| Vera C. Rubin / LSST | 🟢 | Cerro Pachón (Chili) | au sol |
| CTA (gamma) | 🔵 | en construction (Europe + Chili) | au sol |
...
| OSIRIS-APEX | 🔵 | en route vers l'astéroïde Apophis | rencontre avril 2029 |
...
*Script total v3 — mise à jour Provoxys & Lalie : nouveaux engins (MAVEN, Solar Orbiter,
OSIRIS-APEX, Luna 1 & 2, Gaia, Cheops, Subaru, Gemini, LBT, Vera C. Rubin/LSST, CTA),
responsables (👥) derrière chaque mission, chapitre « Les Femmes de l'Espace ». 0 doublon de
fiche, écarts signalés, anti-intox intégrés, localisation par objet, modèles 3D câblés. À
vérifier intégralement (Dossier V) avant publication.*
